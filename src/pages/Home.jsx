    ...
    return (
      <section className='w-full h-full bg-orange-100'>
        <div className='flex justify-center w-full h-screen mt-2 gap-x-4 flex-wrap'>
          <div className='w-6/12 bg-black h-2/5 flex justify-center items-center shadow-lg cursor-pointer'>
            <Link to="/albums" className='font-bold text-white cursor-pointer h-full w-full flex justify-center items-center'>Albums</Link>
          </div>
